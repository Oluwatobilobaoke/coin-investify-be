exports.registerEmailContent = async (firstName, amountInUsd, amountInBtc, addressSentTo, depositDate, depositExpiryDate) => {
                ...
                <tr>
                  <td>
                    ...
                    <div class="mail-body">
                      ...
                      <div class="content">
                        You Just initiated a deposit of <p>$${amountInUsd}</p>, 
                        of which you are required to pay the equivalent of 
                        <p>${amountInBtc}BTC<p> 
                        into this wallet ${addressSentTo}
                        On ${depositDate}, it expire in ${depositExpiryDate}
