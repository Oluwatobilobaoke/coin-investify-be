                ...
                <tr>
                  <td>
                    <div class="mail-header-container" style="text-align: center">
                      <img class="header" src="${process.env.ZURI_TALENT_WELCOME_EMAIL_HEADER}" alt="Header" border="0">
                    </div>
                    <br>
                  </td>
                </tr>
                    ...
                    <div class="mail-btm">
                      <div class="inner">
                          ...
                          <div class="unsubscribe">
                              <span>email: </span>
                              <span>
                                <a href="mailto:talent@zuri.team" style="color:white">talent@zuri.team</a>
                              </span>
